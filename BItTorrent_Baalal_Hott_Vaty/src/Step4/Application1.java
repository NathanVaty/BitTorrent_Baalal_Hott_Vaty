    ...
    private void btn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validerActionPerformed
        ...
        try {
            if (!possedeFich) {
                ...
                Client cli = new Client(1,txt_ipserv.getText());
                finRecup = cli.recupererFichier();
                while(!finRecup){}
                 option_complet.showMessageDialog(null, "Fichier Reconstitue dans le dossier "
                        + "C:\\BitTorrentStep4Appli1, Vous devenez serveur qui envoie des blocs de données",
...
//                    frames[0].addWindowListener(new WindowAdapter() {
//                        public void windowClosing(WindowEvent e) {
//                            try {
//                                System.out.println("okkk");
//                                pms.println("fin connexion");
...
//                    });
//                    
//                    frames[1].addWindowListener(new WindowAdapter() {
//                        public void windowClosing(WindowEvent e) {
//                            try {
//                                System.out.println("okkk");
//                                pms.println("fin connexion");
